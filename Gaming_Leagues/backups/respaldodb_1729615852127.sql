...
14	4	1	2	2024-05-13	2	\N
15	5	2	5	2024-05-13	3	\N
16	3	1	5	2024-05-14	5	\N
17	11	1	5	2024-05-14	4	\N
21	1	1	2	2024-10-22	5	\N
19	5	6	5	2024-10-22	5	\N
20	1	1	2	2024-10-22	4	\N
\.
...
SELECT pg_catalog.setval('public.games_game_code_seq', 12, true);
...
SELECT pg_catalog.setval('public.leagues_league_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.matches_match_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.matches_teams_match_id_seq', 21, true);
